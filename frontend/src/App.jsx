    ...
    <div className="min-h-screen bg-gradient-to-br from-gray-900 via-purple-900 to-gray-900">
      ...
      <div className="relative overflow-hidden">
        ...
        <div className="relative max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 py-16">
          <div className="text-center">
            <h1 className="text-5xl sm:text-6xl font-bold text-transparent bg-clip-text bg-gradient-to-r from-purple-400 via-pink-400 to-purple-400 mb-4">
            ...
            <div className="flex flex-wrap justify-center gap-4 mb-8">
              ...
              <button
                ...
                className="inline-flex items-center px-6 py-3 bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 text-white rounded-lg transition transform hover:scale-105"
              >
                Try It Now
      ...
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8 pb-16">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-6 hover:border-purple-500 transition">
          ...
          <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-6 hover:border-pink-500 transition">
        ...
        {/* Tech Stack */}
        <div className="bg-gray-800/50 backdrop-blur-sm border border-gray-700 rounded-lg p-6 mb-16">
          ...
          <div className="grid md:grid-cols-2 gap-4 text-gray-300">
            <div>
              <span className="font-semibold text-purple-400">Backend:</span> FastAPI, PyTorch, Transformers
            </div>
            <div>
              <span className="font-semibold text-purple-400">AI Models:</span> BLIP (Vision) + Gemma 2B (Text)
            </div>
            <div>
              <span className="font-semibold text-purple-400">MLOps:</span> DVC, pytest, Prometheus, GitHub Actions
            </div>
            <div>
              <span className="font-semibold text-purple-400">Deployment:</span> Docker, Hugging Face Spaces
            </div>
          </div>
        </div>

        {/* Main Application */}
        <div id="generator" className="bg-gray-800/80 backdrop-blur-sm rounded-lg shadow-2xl border border-gray-700">
          ...
          <div className="p-6">
            <div className="flex justify-center mb-8 bg-gray-900/50 rounded-lg p-1.5">
              <button
                onClick={() => setMode('image')}
                className={`w-full py-2 px-4 rounded-md transition-all font-semibold ${mode === 'image' ? 'bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg' : 'hover:bg-gray-700 text-white'}`}
              >
                📸 Image Mode
              </button>
              <button
                onClick={() => setMode('attributes')}
                className={`w-full py-2 px-4 rounded-md transition-all font-semibold ${mode === 'attributes' ? 'bg-gradient-to-r from-purple-600 to-pink-600 shadow-lg' : 'hover:bg-gray-700 text-white'}`}
              >
                ✍️ Text Mode
              </button>
            </div>
            ...
            {mode === 'image' ? (
              <form onSubmit={handleImageSubmit} className="space-y-6">
                <div>
                  ...
                  <div className="mt-2 flex justify-center rounded-lg border-2 border-dashed border-gray-600 hover:border-purple-500 transition px-6 py-10">
                    <div className="text-center">
                      ...
                      <div className="mt-4">
                        <label className="cursor-pointer rounded-md font-semibold text-purple-400 hover:text-purple-500">
                ...
                {imagePreview && (
                  <div>
                    ...
                    <img src={imagePreview} alt="Preview" className="rounded-lg max-h-60 w-auto mx-auto shadow-lg border border-gray-700" />
                  </div>
                )}
                ...
                <div>
                  ...
                  <input
                    ...
                    className="w-full bg-gray-700 border border-gray-600 rounded-lg p-3 text-white focus:ring-2 focus:ring-purple-500 focus:border-transparent"
                ...
                <button
                  ...
                  className="w-full bg-gradient-to-r from-purple-600 to-pink-600 hover:from-purple-700 hover:to-pink-700 disabled:from-gray-600 disabled:to-gray-700 text-white font-bold py-3 px-4 rounded-lg transition-all transform hover:scale-105 disabled:scale-100 disabled:opacity-50"
                >
              ...
              <div className="mt-8 pt-6 border-t border-gray-700">
                ...
                {description && (
                  <div>
                    ...
                    <div className="bg-gray-900/50 border border-gray-700 p-4 rounded-lg text-gray-200">
                      {description}
                    </div>
                  </div>
                )}
          ...
          <div className="grid md:grid-cols-3 gap-8">
            ...
            <div>
              ...
              <div className="flex flex-col space-y-3">
                <a href="https://khushaalchaudhary.com" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
                    <path strokeLinecap="round" strokeLinejoin="round" strokeWidth={2} d="M21 12a9 9 0 01-9 9m9-9a9 9 0 00-9-9m9 9H3m9 9a9 9 0 01-9-9m9 9c1.657 0 3-4.03 3-9s-1.343-9-3-9m0 18c-1.657 0-3-4.03-3-9s1.343-9 3-9m-9 9a9 9 0 019-9" />
                  </svg>
                  Portfolio Website
                </a>
                <a href="https://github.com/khushaal-chaudhary" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M12 0c-6.626 0-12 5.373-12 12 0 5.302 3.438 9.8 8.207 11.387.599.111.793-.261.793-.577v-2.234c-3.338.726-4.033-1.416-4.033-1.416-.546-1.387-1.333-1.756-1.333-1.756-1.089-.745.083-.729.083-.729 1.205.084 1.839 1.237 1.839 1.237 1.07 1.834 2.807 1.304 3.492.997.107-.775.418-1.305.762-1.604-2.665-.305-5.467-1.334-5.467-5.931 0-1.311.469-2.381 1.236-3.221-.124-.303-.535-1.524.117-3.176 0 0 1.008-.322 3.301 1.23.957-.266 1.983-.399 3.003-.404 1.02.005 2.047.138 3.006.404 2.291-1.552 3.297-1.23 3.297-1.23.653 1.653.242 2.874.118 3.176.77.84 1.235 1.911 1.235 3.221 0 4.609-2.807 5.624-5.479 5.921.43.372.823 1.102.823 2.222v3.293c0 .319.192.694.801.576 4.765-1.589 8.199-6.086 8.199-11.386 0-6.627-5.373-12-12-12z"/>
                  </svg>
                  GitHub Profile
                </a>
                <a href="https://linkedin.com/in/khushaal-chaudhary" target="_blank" rel="noopener noreferrer" className="text-gray-400 hover:text-purple-400 transition flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="currentColor" viewBox="0 0 24 24">
                    <path d="M19 0h-14c-2.761 0-5 2.239-5 5v14c0 2.761 2.239 5 5 5h14c2.762 0 5-2.239 5-5v-14c0-2.761-2.238-5-5-5zm-11 19h-3v-11h3v11zm-1.5-12.268c-.966 0-1.75-.79-1.75-1.764s.784-1.764 1.75-1.764 1.75.79 1.75 1.764-.783 1.764-1.75 1.764zm13.5 12.268h-3v-5.604c0-3.368-4-3.113-4 0v5.604h-3v-11h3v1.765c1.396-2.586 7-2.777 7 2.476v6.759z"/>
                  </svg>
                  LinkedIn Profile
                </a>
                <a href="mailto:khushaalchaudhary@outlook.com" className="text-gray-400 hover:text-purple-400 transition flex items-center">
                  <svg className="w-5 h-5 mr-2" fill="none" stroke="currentColor" viewBox="0 0 24 24">
